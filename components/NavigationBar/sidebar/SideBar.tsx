    ...
    <>
      {
        ...
        <aside className="relative top-0 left-0 flex flex-col flex-shrink-0 w-64 h-[90vh] font-normal duration-75 transition-width p-1">
          <div className="flex flex-col flex-1 min-h-0 rounded-lg overflow-hidden bg-white border-2 border-gray-200 dark:bg-slate-800 dark:border-gray-700 shadow-md shadow-slate-500">
